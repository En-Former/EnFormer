import copy
from typing import Tuple, Optional, Type, Sequence, Union, List
...
class LayerNorm(nn.Module):
    """Layer Normalization, come from `A ConvNet for the 2020s`(https://arxiv.org/abs/2201.03545).

    Args:
        normalized_shape (int): The number of expected features in input.
        eps (float): a value added to the denominator for numerical stability. Default: 1e-6.
        data_format (str): The format of the input tensor. If
            `channels_first`, the shape of the input tensor should be
            (B, C, H, W). If `channels_last`, the shape of the input
            tensor should be (B, H, W, C). Default: `channels_first`.
    """
    ...
    def __init__(self, normalized_shape: int, eps: float = 1e-6, data_format: str = "channels_first"):
        ...
        if self.data_format not in ["channels_last", "channels_first"]:
            raise NotImplementedError(f'{self.data_format} is unsupported.'
                                      f'Only support "channels_last" and "channels_first".')
...
class ClusterStage(nn.Module):
    def __init__(self, in_channels: int, out_channels: int, num_blocks: int, num_heads: int = 4, head_dim: int = 24,
        ...
        for i in range(num_blocks):
            block = EnsembleBlock(in_channels, in_channels, num_heads, head_dim, use_agents, agents_hw, clusters_hw,
...
class EnsembleFormer(nn.Module):
    ...
    detection_arch_settings = {
        'S': [[40, 2, 1, 20, True, (40, 40), [(12, 12), (10, 10)], ['FuzzyClustering', 'PartitionalClustering'], False, False, True,
               None, 4., 3, None, (0., 0.), 1e-6, True, True],
              [80, 2, 2, 20, True, (40, 40), [(12, 12), (10, 10)], ['FuzzyClustering', 'PartitionalClustering'], False, False, True,
               None, 4., 3, None, (0., 0.), 1e-6, True, True],
              [160, 10, 4, 20, False, None, [(12, 12), (10, 10)], ['FuzzyClustering', 'PartitionalClustering'], False, False, True,
               None, 4., 3, None, (0., 0.), 1e-6, True, True],
              [320, 4, 8, 20, False, None, [(12, 12), (10, 10)], ['FuzzyClustering', 'PartitionalClustering'], False, False, True,
               None, 4., 3, None, (0., 0.), 1e-6, True, False]],

        'B': [[64, 2, 1, 32, True, (40, 40), [(12, 12), (10, 10)], ['FuzzyClustering', 'PartitionalClustering'], False, False, True,
               None, 4., 3, None, (0., 0.), 1e-6, True, True],
              [128, 2, 2, 32, True, (40, 40), [(12, 12), (10, 10)], ['FuzzyClustering', 'PartitionalClustering'], False, False, True,
               None, 4., 3, None, (0., 0.), 1e-6, True, True],
              [320, 6, 5, 32, False, None, [(12, 12), (10, 10)], ['FuzzyClustering', 'PartitionalClustering'], False, False, True,
               None, 4., 5, None, (0., 0.), 1e-6, True, True],
              [512, 2, 8, 32, False, None, [(12, 12), (10, 10)], ['FuzzyClustering', 'PartitionalClustering'], False, False, True,
               None, 4., 5, None, (0., 0.), 1e-6, True, False]],

        'L': [[64, 2, 1, 32, True, (40, 40), [(12, 12), (10, 10)], ['FuzzyClustering', 'PartitionalClustering'], False, False, True,
               None, 4., 3, None, (0., 0.), 1e-6, True, True],
              [128, 3, 2, 32, True, (40, 40), [(12, 12), (10, 10)], ['FuzzyClustering', 'PartitionalClustering'], False, False, True,
               None, 4., 5, None, (0., 0.), 1e-6, True, True],
              [320, 14, 5, 32, False, None, [(12, 12), (10, 10)], ['FuzzyClustering', 'PartitionalClustering'], False, False, True,
               None, 4., 7, None, (0., 0.), 1e-6, True, True],
              [512, 4, 8, 32, False, None, [(12, 12), (10, 10)], ['FuzzyClustering', 'PartitionalClustering'], False, False, True,
               None, 4., 7, None, (0., 0.), 1e-6, True, False]],
    }
...
if has_mmdet:
    ...
    class enformer_det(EnsembleFormer):
...
if __name__ == '__main__':
    if has_mmdet:
        imgs = torch.rand(4, 3, 1280, 800).cuda()
        enformer = enformer_det(
            arch='S',
            task='detection',
            out_indices=(0, 1, 2, 3),
            drop_path_rate=(0., 0.),
